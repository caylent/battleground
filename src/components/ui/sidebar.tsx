...
function Sidebar({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="flex h-full w-full flex-col overflow-hidden bg-transparent group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow-sm"
          data-sidebar="sidebar"
